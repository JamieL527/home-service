...
import { Route, ArrowLeft, CheckCircle } from 'lucide-react'
...
const STATUS_BADGE: Record<string, { label: string; cls: string }> = {
  assigned:    { label: 'Assigned',    cls: 'bg-yellow-900/60 text-yellow-300 border border-yellow-500/40' },
  ...
  return (
    <div className="-m-4 sm:-m-6 flex flex-col" style={{ height: 'calc(100vh - 56px)' }}>
          ...
          <div className="min-w-0">
            ...
            {myLeadCount > 0 && (
              <p className="text-[11px] text-gray-400 mt-0.5">
                {myLeadCount} lead{myLeadCount !== 1 ? 's' : ''} submitted
              </p>
            )}
          </div>
        </div>
      ...
      <div className="flex-1 relative">
        ...
        {/* Action buttons */}
        <div className="absolute bottom-32 sm:bottom-8 left-0 right-0 flex justify-center items-center gap-3 px-4 pointer-events-none z-50">
